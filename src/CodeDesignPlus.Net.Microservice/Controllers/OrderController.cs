...
namespace CodeDesignPlus.Net.Microservice.Controllers
{
    ...
    public class OrderController(IMediator mediator, IMapper mapper) : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Order([FromQuery] C.Criteria criteria, CancellationToken cancellationToken)
        {
        ...
        {
            var result = await this.mediator.Send(new FindOrderByIdQuery(id), cancellationToken);
        ...
        [HttpPost]
        public async Task<IActionResult> Order([FromBody] CreateOrderDto data, CancellationToken cancellationToken)
        {
        ...
        [HttpDelete("{id}")]
        public async Task<IActionResult> Order(Guid id, [FromBody] CancelOrderDto data, CancellationToken cancellationToken)
        {
            data.Id = id;
